 ...
 */
function mifo_theme_acquia_marina_preprocess(&$vars) {
...
function mifo_theme_acquia_marina_preprocess_page(&$vars) {
  global $language;
...
function mifo_theme_acquia_marina_preprocess_block(&$vars) {
...
function mifo_theme_acquia_marina_preprocess_node(&$vars) {
  ...
  if (isset($vars['node']->links['node_read_more'])) {
    ...
    $vars['node']->links['node_read_more'] = array(
      'title' => mifo_theme_acquia_marina_themesettings_link(
...
function mifo_theme_acquia_marina_preprocess_comment(&$vars) {
  global $user;
 ...
 */
function mifo_theme_acquia_marina_preprocess_comment_wrapper(&$vars) {
 ...
 */
function mifo_theme_acquia_marina_preprocess_views_view(&$vars) {
 ...
 */
function mifo_theme_acquia_marina_preprocess_search_result(&$variables) {
 ...
 */
function mifo_theme_acquia_marina_username($object) {
 ...
 */
function mifo_theme_acquia_marina_file($element) {
 ...
 */
function mifo_theme_acquia_marina_wordlimit($string, $length = 50, $ellipsis = "...") {
 ...
 */
function mifo_theme_acquia_marina_css_count($array) {
  $count = 0;
 ...
 */
function mifo_theme_acquia_marina_themesettings_link($prefix, $suffix, $text, $path, $options) {
