...
<body>
  ...
  <?php print '<div id="plinks">'; ?>
		...
		foreach ($primary_links as $key=>$curlink)
		{
			$primary_links[$key][title]="<div class='lileftdiv'>&nbsp;</div><div class='licenterdiv'>".$curlink[title]."</div><div class='lirightdiv'>&nbsp;</div><div class='clear'></div>";
